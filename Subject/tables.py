...
class SubjectTable(tables.Table):
    ...
    def render_Operations(self, record):
        return format_html(
            '<a href="{}/edit" class="btn btn-sm btn-success"><i class="fa fa-pencil"></i></a> <a onclick="Delete({})" class="btn btn-sm btn-danger"><i id="delete_{}" class="fa fa-trash delete_course"></i></a>',
